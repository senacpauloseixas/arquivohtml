...
<nav>   
  ...
  <header id="user">
    ...
    <section id="cabeca2" class="jumbotron" >
          ...
          <img src="multimidia/logos/vila.bmp" id="imagemperfil" >
         
       
       <?php 
          include "conexao.php";
          $sql = "select * from empresas where NomeEmpresa='Padaria Vila Granno'";
...
<section id="produtos">
    ...
    <div>
      <?php
      include "conexao.php";
      $sql = "select * from produtos where NomeProduto like '%Vila%'";

          $listar = mysqli_query($conn, $sql);

          while ($campo = mysqli_fetch_array($listar)) {
         
              if ($campo['NomeProduto'] == 'Vila granno Brigadeiros') { 
                 echo "<img src='multimidia/produtos/doces/doces.jpg'>";
                 ?>
                ...
                <p><button class="btn btn-primary" style="background-color: #20DDDD; margin-top: 30px;"><a style="color: white" href="paginabrigadeiroVilla.php">Comprar</a></button></p>
                <hr>
                <?php
               }
              elseif ($campo['NomeProduto'] == 'Vila Granno Torta Salgada') {
                echo "<img src='multimidia/produtos/tortas/torta salgada2.jpg'>";
                ?>
                <h4><br><strong><?php echo $campo['NomeProduto'];?></strong></h4>
                <p><?php echo'Preço:';echo $campo['valorProduto'];?></p>
                <p>Informações do Produto: <br><?php echo $campo['informacoesProduto'];?></p>
                <p>Tamanhos:  <br><?php echo $campo['tamanhoProduto'];?></p>
                <p><button class="btn btn-primary" style="background-color: #20DDDD; margin-top: 30px;"><a style="color: white" href="paginatortavilla.php">Comprar</a></button></p>
                <hr>
                <?php
              }
              else {
                echo "<img src='multimidia/produtos/pizzas/pizza3.jpg'>";
                ?>
                <h4><br><strong><?php echo $campo['NomeProduto'];?></strong></h4>
                <p><?php echo'Preço:';echo $campo['valorProduto'];?></p>
                <p>Informações do Produto: <br><?php echo $campo['informacoesProduto'];?></p>
