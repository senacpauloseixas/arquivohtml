...
<nav>   
  ...
  <header id="user">
    ...
    <section id="cabeca2" class="jumbotron" >
          ...
          <img src="multimidia/perfilempresa.jpg" id="imagemperfil" >
...
<section id="produtos">
    ...
    <div>
      <?php
      include "conexao.php";
      $sql = "select * from produtos where NomeProduto like '%A lareira%'";

          $listar = mysqli_query($conn, $sql);

          while ($campo = mysqli_fetch_array($listar)) {
         
              if ($campo['NomeProduto'] == 'A lareira Brigadeiros') { 
                 echo "<img src='multimidia/produtos/doces/brigadeiros1.jpg'>";
                 ?>
                ...
                <p><button class="btn btn-primary" style="background-color: #20DDDD; margin-top: 30px;"><a style="color: white" href="paginabrigadeirolareira.php">Comprar</a></button></p>
                <hr>
                <?php
               }
              elseif ($campo['NomeProduto'] == 'A lareira Torta Salgada') {
                ...
                <p>Informações do Produto: <br><?php echo $campo['informacoesProduto'];?></p>
                <p>Tamanhos:  <br><?php echo $campo['tamanhoProduto'];?></p>
                <p><button class="btn btn-primary" style="background-color: #20DDDD; margin-top: 30px;"><a style="color: white" href="paginatortalareira.php">Comprar</a></button></p>
                <hr>
                <?php
              }
              else {
                echo "<img src='multimidia/produtos/pizzas/mussarela.jpg'>";
                ?>
                <h4><br><strong><?php echo $campo['NomeProduto'];?></strong></h4>
                <p><?php echo'Preço:';echo $campo['valorProduto'];?></p>
                <p>Informações do Produto: <br><?php echo $campo['informacoesProduto'];?></p>
