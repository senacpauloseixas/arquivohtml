...
<section id="produtos">
    ...
    <div>
      <?php
      include "conexao.php";
      $sql = "select * from produtos where NomeProduto like '%Merci Torta%'";
          ...
          while ($campo = mysqli_fetch_array($listar)) 
          {
                ...
                <p><button class="btn btn-primary" style="background-color: #20DDDD; margin-top: 30px;"><a style="color: white" href="##">adcionar ao carrinho</a></a></button></p>
                <hr>
                <?php
